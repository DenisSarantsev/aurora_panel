...
import "./files/universal/collapse-filter.js"; // Сворачиваем/разворачиваем фильтр
import "./files/universal/switching-templates.js"; // Функционал переключения шаблонов
import "./files/universal/custom-checkbox.js"; // Включение / выключение кастомного чекбокса
// -------------------------------------------------------------------------------------------------------- Функционал работы с таблицей с анкетами
import "./files/fetch.js"; // Запрос на получение данных для страницы анкет
import "./files/applications/applications-functions.js"; // Функции для шаблона с анкетами
import "./files/applications/applications-main-chain.js"; // Выполнение всей цепочки функций -  от фильтрации до вывода анкет на страницу и создания пагинации
// -------------------------------------------------------------------------------------------------------- Функционал работы с таблицей с вакансиями
import "./files/vacancies/vacancies-main-chain.js"; // Выполнение основной цепочки вакансий - от загрузки до отображения и фильтрации
import "./files/vacancies/vacancies-functions.js"; // Функции для шаблона с вакансиями
// -------------------------------------------------------------------------------------------------------- Функционал работы с конкретной заявкой
import "./files/application/application-functions.js"; // Функции для страницы конкретной заявки
// -------------------------------------------------------------------------------------------------------- Подключения окна редактрирования
import "./files/editor.js"; // Скрипты редактора
import "./files/preloader.js"; // Скрипт прелоадера
import "./files/data.js"; // Файл, в которий ми получаем data из Jinja2
//============================================================================================================================================================================================================================================
